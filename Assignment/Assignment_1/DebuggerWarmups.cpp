 ...
 */
const string MyName = "(Riczzoe)";

namespace {
    void theEnd() {
        string text = "THE END!";

        /* Set a 3,  750,  260,  993,  475,  172,  639,  369,  590,  938,  855,  238,  504,  184,  119,  368,  448,  744,  975,  928,  603,  128,  795,  187,  436, 1023,  552,  808,  783,  398,  662,  622,
        311,  372,  breakpoint here. */
        (void) text;
    }
